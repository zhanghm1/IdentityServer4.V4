...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class ExternalController : Controller
    {
        ...
        private async Task<(Users user, string provider, string providerUserId, IEnumerable<Claim> claims)>
        ...
        private async Task<Users> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
